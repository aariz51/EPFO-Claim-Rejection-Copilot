...
export const T: Dict = {
  ...
  q_purpose: { en: 'What is the money for?', hi: 'पैसा किस काम के लिए चाहिए?' },
  p_housing: { en: 'House or flat', hi: 'घर या फ्लैट' },
  p_illness: { en: 'Illness or hospital', hi: 'बीमारी या अस्पताल' },
  p_marriage: { en: 'Marriage', hi: 'शादी' },
  p_education: { en: 'Education', hi: 'पढ़ाई' },
  q_howmuch: { en: 'How much do you want to take out?', hi: 'कितना पैसा निकालना है?' },
  checks_ran: { en: 'checks run against your record', hi: 'आपके रिकॉर्ड पर जांच की गई' },
  will_clear: { en: 'This should clear', hi: 'यह मंज़ूर होना चाहिए' },
  will_fail: { en: 'This would be rejected', hi: 'यह रिजेक्ट हो जाएगा' },
  rule_wanted: { en: 'The rule wants', hi: 'नियम चाहता है' },
  you_have: { en: 'Your record says', hi: 'आपके रिकॉर्ड में है' },
